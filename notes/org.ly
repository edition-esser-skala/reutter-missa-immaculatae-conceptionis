...
SanctusBassFigures = \figuremode {
  ...
  r <4> <_+> r <6> <_->
  <_+>1. r2 q <6 5>
  r4 <6 5 _-> <4>2 <_+> r <6> r %25
  <_+>1. <8 _+>2 <7 2> <\t _+>
  <6 4> <5 _+> r <6>1 <5>2
  r <4> <_+> r1 <6>2
  <_+>1 <\t>2 q1.
  q2 <6 5>1 <5>2 <6-> <6 5-> %30
  r <6> r r1.
  <8 3>2 <7- 2> <\t 3> <6 4> <5 3> <6>
  r1. <8 6>4 <7 5> r1
  r2 <6> r <7->1.
  r\breve. %35
  r2 <6> r r1.
...
BenedictusOrgano = {
  \relative c {
    ...
    d8 g, d' d, g4 \clef bass g,8 h %10
    c d e c g' g, r e'
    f4 r8 f g c, g' g,
    c4 r8 g c4 r8 g'
    c,4 r8 g c4 f8 c
...
AgnusDeiOrgano = {
  \relative c {
    ...
    d g d d, g4 r
    r8 g' e c f! e d4
    g8 c, g' g, c4-\critnote \mvTr c8\fE-\tuttiE g' %15
    c4 c,8 g' c4 c,~
    c h a2
