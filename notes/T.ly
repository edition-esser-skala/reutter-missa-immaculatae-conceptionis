...
GratiasTenoreLyrics = \lyricmode {
  \xE Gra -- ti -- as a -- gi -- mus ti -- bi \x %25
  pro -- pter ma -- gnam
  glo -- ri -- am, glo -- ri -- am
  tu -- am.
...
EtIncarnatusTenoreNotes = {
  \relative c' {
    ...
    f2 r r r1*3/2
    R\breve.*6 %64
    \time 3/2 R1.\fermata \bar "||" %65 finis
  }
}
...
BenedictusTenoreNotes = {
  \relative c' {
    ...
    R1*4
    r2 r4 \mvTr e8\fE^\soloE h %5
    c8.([ d16)] e8 h c8.([ d16)] e8 r
    R1
    r8 c f([ e] d8.) d16 d8 h^\critnote
    c8. c16 g8 g a4.( h16[ c]
    d8) g,16 g d'8 d, g4 r %10
    r r8 e' e d r4
...
DonaNobisTenoreNotes = {
  \relative c' {
    ...
    \mvTr e8.\fE^\tuttiE e16 e8 c c([ d)] e4 r8 g, h([ c)]
    d4 r8 a c([ d)] e4 r8 g, g([ fis)] %20
    g4 r r r1*3/4
    r4 r8 g g4 a r8 a a4
    h4 r8 h h4 c4. h8 a([ c)]
    h4 r8 d e4 d8 d d2
    e4 r r r r8 g, h([ c)] %25
    d4 r8 a c([ d)] e4 r8 a, d([^\critnote e)]
    e4 e e h2 a4
    d2 c4 h h2
    c4 r r e8. e16 e8 d e([ f)]
    e4 r8 g, g([ fis)] g4 r r %30
    r1*3/4 r4 r8 e' c[( d16 e]
    f4) h, g8 a16([ h)] c8 d d2
    e4 r r r1*3/4
